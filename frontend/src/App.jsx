...
function App() {
  ...
  const getFieldDiffClass = (field, value) => {
    ...
    // No value in original - treat as no change (file didn't have this field)
...
album_artist: getValueFromResult(fieldMappings.album_artist),
      ...
      // Auto-generate preview after applying metadata
            ...
            <>
              <div className="metadata-editor">
                ...
                <table className="metadata-table">
                  ...
                  <tbody>
                    <tr>
                      <td>File Name <button className="template-btn" onClick={() => openTemplateHelper('filename')} title="Edit filename template">⚙</button></td>
                      <td>{selectedFile?.filename}</td>
                      <td className={preview?.new_filename ? 'has-change' : ''}>{preview?.new_filename || '-'}</td>
                    </tr>
                    <tr>
                      <td>File Location <button className="template-btn" onClick={() => openTemplateHelper('folder')} title="Edit folder template">⚙</button></td>
